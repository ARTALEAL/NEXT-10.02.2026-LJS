...
- Зарегистрироваться на гитхабе (если нет аккаунта) и создать публичный/приватный репозиторий для домашнего проекта - https://github.com/
...
- запросить доступ к https://github.com/zubkov7/nextjs-20260210-2 и https://github.com/zubkov7/next-webinar-server
